...
namespace uWindowCapture
{
    public class UwcWindowTexture : MonoBehaviour
    {
        ...
        [SerializeField] WindowSearchTiming searchTiming_ = WindowSearchTiming.OnlyWhenParameterChanged;

        public WindowSearchTiming searchTiming
        {
            get { return searchTiming_; }
            set
            {
                searchTiming_ = value;
        ...
        [SerializeField] WindowTextureType type_ = WindowTextureType.Window;
        ...
        [SerializeField] bool altTabWindow_ = false;
        ...
        [SerializeField] bool createChildWindows_ = true;
        ...
        [SerializeField] string partialWindowTitle_;
        ...
        [SerializeField] int desktopIndex_ = 0;
        ...
        public int desktopIndex
        {
            ...
            {
                shouldUpdateWindow = true;
                desktopIndex_ = (UwcManager.desktopCount > 0) ? Mathf.Clamp(value, 0, UwcManager.desktopCount - 1) : 0;
            }
        }
